const CONSERVATIVE_BLOCK_GAS_LIMIT = 15_000_000 // conservative, hard-coded estimate of the current block gas limit
export const DEFAULT_GAS_REQUIRED = 6000000 // the default value for calls that don't specify gasRequired
