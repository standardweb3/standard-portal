...
export const useSizeXs = () => useMediaQuery({ maxWidth: 640 });

export const useSizeSm = () => useMediaQuery({ minWidth: 640, maxWidth: 908 });
export const useSizeSmUp = () => useMediaQuery({ minWidth: 640 });
export const useSizeSmDown = () => useMediaQuery({ maxWidth: 908 });

export const useSizeMd = () => useMediaQuery({ minWidth: 908, maxWidth: 1156 });
export const useSizeMdUp = () => useMediaQuery({ minWidth: 908 });
export const useSizeMdDown = () => useMediaQuery({ maxWidth: 1156 });

export const useSizeLg = () =>
  useMediaQuery({ minWidth: 1156, maxWidth: 1280 });
export const useSizeLgUp = () => useMediaQuery({ minWidth: 1156 });
export const useSizeLgDown = () => useMediaQuery({ maxWidth: 1280 });

export const useSizeXl = () =>
  useMediaQuery({ minWidth: 1280, maxWidth: 1536 });
export const useSizeXlUp = () => useMediaQuery({ minWidth: 1280 });
export const useSizeXlDown = () => useMediaQuery({ maxWidth: 1536 });
