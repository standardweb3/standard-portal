...
import { PERSIST, persistReducer, persistStore,createMigrate } from "redux-persist";
...
const persistConfig = {
  ...
  migrate: createMigrate(migrations, { debug: process.env.NEXT_PUBLIC_NETWORK_ID !== "1" }),
};
