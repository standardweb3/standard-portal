...
const preFix = { pathPrefix: process.env.NEXT_PUBLIC_SERVER_URL }; // 域名
console.log("preFix", preFix);
const client = new WebClient(`${process.env.NEXT_PUBLIC_GRPC_SERVER_URL}`, null, null);
export const getTransferConfigs = (): Promise<GetTransferConfigsResponse> =>
  axios
    .get(`${process.env.NEXT_PUBLIC_SERVER_URL}/v1/getTransferConfigsForAll`)
    .then(res => {
      return res.data;
    })
    .catch(e => {
...
export const getTransferStatus = (params: GetTransferStatusRequest): Promise<GetTransferStatusResponse> => {
  return axios
    .post(`${process.env.NEXT_PUBLIC_SERVER_URL}/v1/getTransferStatus`, {
      ...params,
    })
    .then(res => {
      return res.data;
...
export const transferHistory = (reqParams: TransferHistoryRequest): Promise<TransferHistoryResponse> =>
  axios
    .get(`${process.env.NEXT_PUBLIC_SERVER_URL}/v1/transferHistory`, {
      params: {
        ...reqParams,
      },
    })
...
export const checkTransferHistory = (reqParams: TransferHistoryRequest): Promise<TransferHistoryResponse> =>
  axios
    .get(`${process.env.NEXT_PUBLIC_SERVER_URL_CHECK}/v1/transferHistory`, {
      params: {
        ...reqParams,
      },
    })
