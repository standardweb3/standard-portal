...
export function useDerivedLimitOrderInfo(): {
  ...
  let parsedRate = limitPrice
    ? tryParseAmount(limitPrice, WNATIVE[chainId])
    : undefined;
      ...
      ? isExactIn
        ? CurrencyAmount.fromRawAmount(
            ...
            new Percent(
              ...
              denominator(WNATIVE[chainId].decimals),
            )
              .multiply(
                new Percent(
                  parsedInputAmount.quotient,
                  denominator(inputCurrency.decimals),
                ),
              )
        ...
        : CurrencyAmount.fromRawAmount(
            ...
            new Percent(
              parsedInputAmount
                ...
                .multiply(
                  denominator(
                    WNATIVE[chainId].decimals - outputCurrency.decimals,
                  ),
                ).quotient,
              parsedRate.quotient,
            ).quotient,
  ...
  const bestTradeExactIn = useTradeExactIn(
    isExactIn ? parsedInputAmount : undefined,
  ...
  const balance = useMemo(
    () =>
      bentoBoxBalances?.find(
        (el) => el.address === inputCurrency?.wrapped.address,
      ),
