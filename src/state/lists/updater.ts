...
export default function Updater(): null {
  ...
  const loadList = useMemo(() => router.pathname !== '/trade', [router]);
  ...
  }, [dispatch, fetchList, library, lists, loadList]);
